...
class CalendarManager {
	...
	init() {
		this.dateInput = document.getElementById(`openCalendar-${this.key}`);
		this.calendar = document.getElementById(`calendar-${this.key}`);
		this.calendarDays = document.getElementById(`calendarDays-${this.key}`);
		this.monthSelect = document.getElementById(`monthSelect-${this.key}`);
		this.yearSelect = document.getElementById(`yearSelect-${this.key}`);
		this.prevMonthBtn = document.querySelector(`.prev-month-${this.key}`);
		this.nextMonthBtn = document.querySelector(`.next-month-${this.key}`);
	...
	populateSelectors() {
		...
		CONFIG.CALENDAR.monthNames.forEach((month, index) => {
			const option = document.createElement('option');
			option.value = index;
			option.textContent = month;
